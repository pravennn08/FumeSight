...
const API_KEY = "re_N7e1fqXV_FPvc2U4c9kJeF5iinUj8qUs4";
const resend = new Resend(API_KEY);

const SMOKE_ALERT_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
const AIR_QUALITY_ALERT_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
const SMOKE_AND_AIR_QUALITY_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
await resend.emails.send({
  ...
  to: "magbanuaraven08@gmail.com",
  subject: "SmogSight",
  html: SMOKE_AND_AIR_QUALITY_TEMPLATE.replaceAll(
    /\{(smokeVal|airQualityVal)\}/g,
    (match) => {
      if (match === "{smokeVal}") return 90;
      if (match === "{airQualityVal}") return 50;
      return match;
    }
  ),
  // AIR_QUALITY_ALERT_EMAIL_TEMPLATE.replace("{airQualityVal}", 50),
  //SMOKE_ALERT_EMAIL_TEMPLATE.replace("{smokeVal}", 90),
});
